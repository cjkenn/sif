...
// TODO: might need to use &Instr instead -> actually, the generational arena crate might
// be the best option, particularly for optimizations because we can add/remove instructions
